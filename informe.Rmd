...
__2.__ Realice un análisis exploratorio bivariado de datos enfocado en la relaciónentre la variable respuesta (y=precio) en función de la variable predic-tora (x=area) - incluir gráficos e indicadores apropiados interpretados.
